    ...
    <section className="bg-white overflow-hidden mb-28">
      <div className="flex flex-wrap">
        ...
        <div className="lg:w-1/2 w-full px-5 md:px-10 mb-6 lg:mb-0 flex flex-col gap-4 2xl:w-2/5 2xl:pr-24">
          <h1 className="animate-fade-right animate-once text-black text-3xl md:text-5xl font-semibold mb-4 leading-normal">
            Trusted by thousands of Nigerians
          </h1>
          <p className="animate-fade-up animate-once text-base md:text-3xl font-normal text-black leading-normal">
